...
var BuiltInColumnFormats = map[string]PsmlColumnInfo{
	...
	"%ud":     PsmlColumnInfo{Field: "%ud", Short: "Dest", Long: "Dest addr (unresolved)", Comparator: pcaptui.IPCompare{}},                      /* 11) COL_UNRES_DST */
	...
	"%und":    PsmlColumnInfo{Field: "%und", Short: "Dest", Long: "Net dest addr (unresolved)", Comparator: pcaptui.IPCompare{}},                 /* 30) COL_UNRES_NET_DST */
	"%rns":    PsmlColumnInfo{Field: "%rns", Short: "Source", Long: "Net src addr (resolved)"},                                                   /* 31) COL_RES_NET_SRC */
	"%uns":    PsmlColumnInfo{Field: "%uns", Short: "Source", Long: "Net src addr (unresolved)", Comparator: pcaptui.IPCompare{}},                /* 32) COL_UNRES_NET_SRC */
	...
	"%s":      PsmlColumnInfo{Field: "%s", Short: "Source", Long: "Source address", Comparator: pcaptui.IPCompare{}},                             /* 39) COL_DEF_SRC */
	...
	"%us":     PsmlColumnInfo{Field: "%us", Short: "Source", Long: "Src addr (unresolved)", Comparator: pcaptui.IPCompare{}},                     /* 42) COL_UNRES_SRC */
...
// it async. This is called from pcaptui's main and makes specific assumptions i.e. that it can write
...
func InitValidColumns() error {
	...
	if err != nil {
		fmt.Printf("Pcaptui is initializing - please wait...\n")
...
func (w *ColumnsFromTshark) InitFromCache() error {
	newer, err := pcaptui.FileNewerThan(pcaptui.CacheFile("tsharkcolumnsv2.gob.gz"), pcaptui.DirOfPathCommandUnsafe(pcaptui.TSharkBin()))
	if err != nil {
		return err
	}
	...
	f := []PsmlColumnSpec{}
	err = pcaptui.ReadGob(pcaptui.CacheFile("tsharkcolumnsv2.gob.gz"), &f)
	if err != nil {
		return err
	}
...
func (w *ColumnsFromTshark) InitNoCache() error {
	...
	cmd := exec.Command(pcaptui.TSharkBin(), []string{"-G", "column-formats"}...)
