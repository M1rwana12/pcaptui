...
{{define "NameVer"}}pcaptui {{.Version}}{{end}}
...
{{template "OneLine"}}
See https://github.com/m1rwana12/pcaptui for more information.{{end}}
...
$ pcaptui -r file.pcap -T psml -n | less{{end}}
...
term__________________ - make pcaptui assume this terminal type
...
pcaptui is in copy-mode. You can press:
...
func init() {
	EnsureTemplateData()
	TemplateData["Version"] = pcaptui.Version
	TemplateData["FAQURL"] = pcaptui.FAQURL
