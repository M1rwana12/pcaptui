...
import (
	...
	"github.com/m1rwana12/pcaptui/widgets/framefocus"
	"github.com/m1rwana12/pcaptui/widgets/keepselected"
	"github.com/m1rwana12/pcaptui/widgets/regexstyle"
	"github.com/m1rwana12/pcaptui/widgets/scrollabletable"
	"github.com/m1rwana12/pcaptui/widgets/trackfocus"
...
type Widget struct {
	...
	keyState       *pcaptui.KeyState       // for vim key chords that are intended for table navigation
...
func New(displayFilter string, captureDevice string, proto streams.Protocol,
	convMenu *menu.Widget, convMenuHolder *holder.Widget, keyState *pcaptui.KeyState,
	opts ...Options) *Widget {
	var opt Options
	if len(opts) > 0 {
		opt = opts[0]
